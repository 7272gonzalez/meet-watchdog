...
echo ""
echo "Done! The watchdog will alert you every minute when a Google Meet is active."
echo ""
echo "NOTE: On first run, macOS may ask for permission to access Calendar and control"
echo "Google Chrome. Accept both prompts — the watchdog needs them to work."
echo ""
...
echo "  ALERT_BEFORE_MINUTES  — how early to start alerting (default: 2)"
echo "  GRACE_PERIOD_MINUTES  — how long to keep the meeting in the alert window (default: 15)"
echo "  MAX_ALERTS            — max number of alerts before giving up (default: 3)"
